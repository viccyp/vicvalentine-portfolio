  ...
  return (
    <section id="about" className="py-20 bg-black text-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <h2 className="text-4xl md:text-5xl font-bold text-center mb-12 uppercase tracking-wider">About Me</h2>
        <div className="prose prose-lg max-w-none text-center">
          ...
          <p className="text-lg text-gray-400 leading-relaxed">
            Whether you need a reliable session drummer for your gig, professional recording services, or expert drum lessons, 
            I'm here to help you achieve your musical goals.
          </p>
        </div>
      </div>
    </section>
