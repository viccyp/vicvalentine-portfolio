        ...
        <div className="flex justify-between items-center h-16">
          <div className="flex-shrink-0">
            <button
              ...
              className="text-white text-xl font-bold hover:text-[#D4A574] transition-colors uppercase tracking-normal"
            >
              Vic Valentine
            </button>
          </div>
          ...
          <div className="hidden md:block">
            <div className="ml-10 flex items-baseline space-x-8">
              <button
                ...
                className="text-gray-300 hover:text-[#D4A574] px-3 py-2 text-sm font-medium transition-colors uppercase tracking-normal"
              >
                About
              </button>
              <button
