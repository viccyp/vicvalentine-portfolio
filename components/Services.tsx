      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {services.map((service, index) => (
            <div
              key={index}
              className="bg-gray-900 p-8 rounded-lg border border-gray-800 hover:border-[rgb(120,30,150)] transition-all duration-300 hover:shadow-xl hover:shadow-[rgb(120,30,150)]/20"
            >
              <div className="text-5xl mb-4 text-center">{service.icon}</div>
              <h3 className="text-2xl font-bold mb-4 text-[rgb(120,30,150)] uppercase tracking-normal">{service.title}</h3>
